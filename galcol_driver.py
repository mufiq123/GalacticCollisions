...
#galcol.init_disk(galaxies['part1'])
...
#t, data = galcol.evolve_disk(galaxies['target'],
#                                  N_steps=10000, N_snapshots=500, time_step=0.05 * unit.Myr)
...
# In[ ]:
#galcol.show_orbits([0,1000,2000,3000,4000],data)
#temp = []
#xx=0
#while xx < 4000:
##    xx+=500
#    temp.append(xx)
#galcol.anim_orbits(temp,data,[-15,15],[-15,15],t)


galcol.anim_two_disks_2d(data, galaxies['target']['N_stars'], [-10, 35], [-35, 10], name='Collision2D')
galcol.anim_two_disks_3d(data, galaxies['target']['N_stars'], [-15, 15], [-15, 15], [-15, 15],time= t, name='Collision3D')
